<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MainForm.Master" AutoEventWireup="true" CodeBehind="ListDOU.aspx.cs" Inherits="AisInfoService.Pages.ListDOU" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <form class="formsearch mb20">
                        ...
                        <div class="col-md-4 form-group">
                            <label for="exampleInputEmail2">Номер ДОУ</label>
                            <select name="NumDou" class="form-control">
                                <option>1</option>
                                <option>1</option>
                                <option>1</option>
                                <option>1</option>
